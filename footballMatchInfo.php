...
?>
    ...
    <div class="Hero_image_football">
<?php
require 'db_connect.php';
 $query =  "SELECT * FROM forfile ORDER BY id DESC LIMIT 1";
  ...
  <div class="row for-hero" style="">
    ...
    <img class="football-hero-image" src="./images/<?php echo $post['image']?>" alt="">
  </div>
  <?php endforeach;?>
    </div>
    ...
    <div style="background-color: #091c61; padding:10px;color:white;">
        <h2 style="margin-bottom:0px">Nepal football Match List</h2>
        </div>
        <?php
        ...
        <div class="wrap_games">
            ...
            <div class="wrap_live_stream">
                <span class="stream_match"><a href="UserliveFootballStream.php?id=<?php echo $news['id'];?>">
