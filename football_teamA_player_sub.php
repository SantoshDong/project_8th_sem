...
//echo $name."<br/>".$position;
  // $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if($a==5){
            header('location:football_teamB_player.php');
        }
    } else {
    ...
    ?>
       <h1 style="text-align:center;"><span class="heading">Enter substitute player of<span style="font-size:3rem;text-transform:uppercase;color:red;font-weight:900"> <?php echo $_SESSION['football_teamA']?></span></span></h1>
