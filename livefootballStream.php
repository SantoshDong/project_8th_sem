...
if($result){
    if(mysqli_num_rows($result)>0){
        ...
        while($news = mysqli_fetch_assoc($result)){
            //print_r($news); 
            $_SESSION['football_teamA']=$news['teamA']; 
            $_SESSION['football_teamB']=$news['teamB'];    
            $_SESSION['football_id']=$id;  
?>
<!--<div class="wrap_news">-->
...
<div class="wrap_match_list">
    ...
    <h4 style="border:1px solid black;text-align:center;text-transform:uppercase;border-radius:10%;"><a style="text-decoration:none" href="football_teamA_player.php">insert player</a>
        </div>
</div>
<?php
        }
