...
//echo $name."<br/>".$position;
  // $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    ...
    if ($conn->query($sql) === TRUE) {
        ...
        if($a==4){
            header('location:teamB_player.php');
        }
    } else {
    ...
    ?>
           <h1 style="text-align:center;"><span class="heading">Enter player of<span style="font-size:3rem;text-transform:uppercase;color:red;font-weight:900"> <?php echo $_SESSION['teamA'];?></span></span></h1>
